function [ForcePlateData] = Process_GRF(AnalogSignals,threshold,grf_filter,AnalogFrameRate,ParameterGroup,RotationMatrix)
...
%       matrices decribe the tranformation that rotates the data of the 
%       forceplate to the vicon marker coordinate system (.Forceplate) and
%       from the vicon marker coordinate system to opensim (.Markers)
%
% OUTPUT:
%   ForcesPlateData
...
% 
% Original author: Maarten Afschrift, adapted from code from Aymnan Habib
% Original date: ??
%
% Last editted by: 
